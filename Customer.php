...
if (isset($_GET['email'])) {
    ...
    $sql = "SELECT * FROM sell where customer_email = '$email'";
...
<head>
    ...
    <title>Customer || CAR DEALERSHIP</title>
</head>
<body>
    <!-- nav -->
    ...
    <div class="order-history-section md:w-6/12 m-auto">
        ...
        <table class="table-auto w-full border-collapse border border-gray-300">
            ...
            ?>
                <tr>
                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($row['car_name']); ?></td>
                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($row['car_type']); ?></td>
                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($row['car_model']); ?></td>
                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($row['car_year']); ?></td>
                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($row['car_fuel']); ?></td>
                    <td class="border border-gray-300 px-4 py-2"><?php echo htmlspecialchars($row['car_price']); ?></td>
                </tr>
            <?php
            }
            ?>
