...
$sql = "SELECT image,name,type,model,year,fuel,price,quantity FROM car";
...
<body>
    ...
    <div class="order-history-section md:w-8/12 m-auto">
        <div class="flex w-full pb-5 md:w-6/12 m-auto">
            <a href="admin.php" class="text-center w-[50%] border-b-2 border-gray-100 py-3 m-auto">User List</a>
            <a href="car.php" class="text-center w-[50%] border-b-2 border-red-500 py-3 m-auto">Car List</a>
            <a href="sell.php" class="text-center w-[50%] border-b-2 border-gray-100 py-3 m-auto">Sell History</a>
        </div>
        <a class="bg-blue-500 text-white px-5  py-2 rounded-xl mb-5" href="addcar.php">ADD CAR</a>
        <table class="table-auto w-full border-collapse border border-gray-300">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="border border-gray-300 px-4 py-2 text-left">Model Year</th>
                    <th class="border border-gray-300 px-4 py-2 text-left">fuel</th>
            ...
            <tbody>
                <?php 
                    ...
                    ?>
                    <tr">
                        <td class="border border-gray-300 px-4 py-2"><img class="w-[100px] h-auto" src="<?php echo $row['image']?>" alt=""></td>
                        ...
                        <td class="border border-gray-300 px-4 py-2"><?php echo $row['model']?></td>
                        <td class="border border-gray-300 px-4 py-2"><?php echo $row['year']?></td>
                        <td class="border border-gray-300 px-4 py-2"><?php echo $row['fuel']?></td>
                        <td class="border border-gray-300 px-4 py-2"><?php echo $row['quantity']?></td>
                        <td class="border border-gray-300 px-4 py-2">
                            <a class="bg-blue-500 text-white px-5  py-1 rounded-xl" href="editCarInfo.php?model=<?php echo urlencode($row['model']); ?>" class="btn btn-primary">Edit</a>
                            <a class="bg-red-500 text-white px-5  py-1 rounded-xl" href="confiq/deleteCar.php?model=<?php echo urlencode($row['model']); ?>" class="btn btn-primary">Delete</a>
                        </td>
                    </tr>
                    <?php
                    }
